% XCircuit output "ckt_1.tex" for LaTeX input from ckt_1.eps
...
\def\midbox#1{\raisebox{-0.20\baselineskip}[0in][0in]{#1}}
   ...
   \putbox{0.98in}{0.80in}{1}{$v_{cc}$}%
   \putbox{1.43in}{0.87in}{1}{$i_{cc}$}%
   \putbox{2.1in}{0.80in}{1}{$v_{R_2}$}%
   \putbox{1.65in}{0.58in}{1}{$i_{R_2}$}%
   } % close 'parbox'
   } % close 'scalebox'
